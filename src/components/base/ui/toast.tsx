...
export function ToastClose({
  ...
  return (
    <ToastPrimitives.Close
      ...
      className={cn(
        "cursor-pointer absolute top-1 right-1 sm:top-2 sm:right-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-hidden focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-red-300 hover:group-[.destructive]:text-red-50 focus:group-[.destructive]:ring-red-400 focus:group-[.destructive]:ring-offset-red-600",
        "group-[.success]:text-white/80 hover:group-[.success]:text-white focus:group-[.success]:ring-emerald-200/60",
        "rtl:right-auto rtl:left-1 sm:rtl:left-2 z-20",
        className
      )}
      toast-close=""
      {...props}
...
export function ToastTitle({
  ...
  return (
    <ToastPrimitives.Title
      ...
      className={cn(
        "font-semibold text-sm sm:text-base [&+div]:text-sm",
        className
      )}
      {...props}
    />
